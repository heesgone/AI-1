...
for fold, (train_idx, val_idx) in enumerate(
    ...
    plt.savefig(f'./results/matrix/confusion_matrix_vgg19_fold{fold}.png',
                bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f'./results/graphs/curve_vgg19_fold{fold}.png', bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f'./results/graphs/figure8_replication_fold{fold}_vgg19.png',
                bbox_inches='tight', dpi=200)
    plt.close()
...
plt.tight_layout()
plt.savefig('./results/graphs/10fold_summary_vgg19.png', bbox_inches='tight', dpi=150)
plt.close()
print("\n요약 그래프 저장: ./results/graphs/10fold_summary_vgg19.png")
...
def save_feature_maps(block_out, block_name, label):
    ...
    plt.tight_layout()
    plt.savefig(f'./results/featuremaps/{block_name.lower()}_vgg19_featuremaps.png',
                bbox_inches='tight')
    plt.close()
