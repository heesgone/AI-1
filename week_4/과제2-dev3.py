...
plt.tight_layout()
plt.savefig('training_curves_dev3_epoch20.png')
print("\n=== 학습 그래프(training_curves_dev3_epoch20.png) 저장 완료 ===")
...
def save_feature_maps(feature_map, layer_name, num_kernels=16):
    ...
    plt.tight_layout()
    filename = f'feature_map_{layer_name}_dev3_epoch20.png'
